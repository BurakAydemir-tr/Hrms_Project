...
public class SchoolsController {
	...
	public DataResult<List<School>> findAllByResumeIdOrderByEndedDateDesc(@RequestParam int id){
		return this.schoolService.findAllByResumeIdOrderByEndedDateDesc(id);
	}
}
